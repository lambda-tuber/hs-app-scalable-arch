...
module ASA.Domain.Service.ControlSpec (spec) where
...
import qualified ASA.Domain.Service.Control as SUT
import qualified ASA.Domain.Service.Type as SUT
